			...
			<v-row align="center" justify="center" no-gutters>
				...
				<v-col xs="12" md="12" lg="5" xl="5" xxl="5">
					<v-card class="ml-4" :elevation="0">
						<p class="mb-4 font-weight-light text-blue-grey-darken-3">Thanks for stopping by! I'm looking to
							join a new team of creative designers and
							developers. If you think we'd be a great fit, send me an email.</p>
						<ContactForm />
					</v-card>
				</v-col>
			</v-row>
