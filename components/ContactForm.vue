<template>
  <div>
    ...
    <form @submit.prevent="submitForm">
      ...
      <vue-hcaptcha class="mb-0 not-verified" sitekey="50b2fe65-b00b-4b9e-ad62-3ba471098be2" @verify="onVerify"
        :reCaptchaCompat="false" language="en" />
      <v-btn type="submit" color=green :disabled="isButtonDisabled" :append-icon="buttonIcon">
        {{ buttonLabel }}
        <v-progress-circular v-if="showLoader" class="ml-3" color="grey-lighten-3" :size="25"  indeterminate></v-progress-circular>
      </v-btn>
    </form>
  </div>
</template>
